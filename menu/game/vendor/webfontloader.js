...
(function() {
  ...
  function T(a) {
    ...
    d
      ? p() - a.ga >= a.v
        ? S() && ja(a, b, c) && (null === a.Z || a.Z.hasOwnProperty(a.f.getName())) ? U(a, a.G) : U(a, a.J)
        : ka(a)
      : U(a, a.G);
  }
  function ka(a) {
  ...
  V.prototype.V = function(a) {
    ...
    b.u &&
      t(
        ...
        [b.e.d(b.g, a.getName(), I(a).toString(), 'loading'), b.e.d(b.g, a.getName(), I(a).toString(), 'inactive')]
      );
    J(b, 'fontactive', a);
    this.ba = !0;
    ma(this);
  ...
  ta.prototype.parse = function() {
    for (var a = this.o.length, b = 0; b < a; b++) {
      ...
      if (2 <= c.length) {
        ...
        0 < f.length && (e = f);
        3 == c.length &&
          ((c = c[2]), (f = []), (c = c ? c.split(',') : f), 0 < c.length && (c = ua[c[0]]) && (this.I[d] = c));
      }
